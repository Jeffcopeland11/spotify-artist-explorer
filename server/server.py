...
def get_genre_artists(genre_name):
    response = spotify.recommendations(seed_genres=genre_name, limit=50)
...
def get_top_tracks(artist_id):
    ...
    response = spotify.artist_top_tracks(artist_id, country)
    return jsonify(response)
...
def search():
    ...
    response = spotify.search(q, type=type, limit=limit)
    return jsonify(response)
